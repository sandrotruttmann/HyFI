...
**HyFI** is a Python package for imaging seismically active faults in 3D based on relocated earthquake hypocenter datasets. The method uses nearest neighbor learning and principal component analysis (PCA) to reconstruct 3D fault geometries from spatiotemporal hypocenter and focal mechanism catalogs.
