...
\begin{itemize}
    ...
    \item Advantage: Sample-efficient, uncertainty quantification
    \item Use case: Time-constrained analysis
\end{itemize}
...
\begin{itemize}
    ...
    \item Snoek et al. (2012). \textit{Practical Bayesian Optimization of Machine Learning Algorithms}. NeurIPS.
\end{itemize}
...
The implementation in the HyFI workflow supports multiple optimization methods (Grid Search, Bayesian Optimization, Optuna) and has been validated on real-world earthquake catalogs, demonstrating its effectiveness in identifying optimal parameters for accurate fault plane reconstruction.
