...
import fault_network, model_validation, stress_analysis, auto_class, utilities, visualisation_Lenk


# ##########################    Input parameters     ###########################
input_params = {
    ###     General settings
    'project_title' : 'Lenk',                               # Project title
    ###     Hypocenter input file
    'hypo_file' : '/home/sandro/ownCloud/SPEKTRUM_DevOps/02_Projekte/0038_swisstopo_Tektonik/Analyse/hypo_fault_imaging/Lenk/hypoDD_Lenk_onlyrelative.csv',        # File location
    'hypo_sep' : ',',                                                 # Separator
    ###     Output directory
    'out_dir' : '/home/sandro/ownCloud/SPEKTRUM_DevOps/02_Projekte/0038_swisstopo_Tektonik/Analyse/hypo_fault_imaging/Lenk/',
    ###     "Fault network reconstruction" module settings
    'n_mc' : 1,                      # number of Monte Carlo simulations
    'r_nn' : 300,                       # search radius [m] of nearest neighbor search
    'dt_nn' : 8766,                    # search time window [h]
    'mag_type' : 'ML',                  # magnitude type: 'ML' or 'Mw'
    ###     "Model Validation" module settings
    'validation_bool' : True,
    'foc_file' : '/home/sandro/ownCloud/SPEKTRUM_DevOps/02_Projekte/0038_swisstopo_Tektonik/Analyse/hypo_fault_imaging/Lenk/FM_Lenk.csv',
    'foc_sep' : ',',
    ...
    'S1_plunge' : 20,                   # σ1 plunge
    'S3_trend' : 34,                    # σ3 trend
    'S3_plunge' : 12,                   # σ3 plunge
    'stress_R' : 0.3,                  # Stress shape ratio
...
###############################################################################
# Visualisation
visualisation_Lenk.model_3d(input_params, data_input, data_input_outliers, data_output)
visualisation_Lenk.faults_stereoplot(input_params, data_output)
